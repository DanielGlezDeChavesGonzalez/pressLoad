...
export default function footer(){
  return(
    <footer className="absolute inset-x-0 bottom-0 mx-auto pt-12 pb-6 px-10 tracking-wide bg-gradient-to-t from-gray-700 ">
      <div className="max-w-full">
        ...
        <p className="text-gray-400 text-sm mt-10">© pressLoad. All rights reserved.
        </p>
      </div>
    </footer>
  )
